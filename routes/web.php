...
Route::group(['middleware' => ['auth']], function ()
{
    ...
    Route::get('/farmlab/create', 'PracticeController@create')->name('farmlab.create')->middleware('farmlab');
    Route::post('/farmlab/create', 'PracticeController@store')->name('farmlab.store')->middleware('farmlab');
